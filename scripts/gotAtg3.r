...
grep("Il1b", annot$gene1)
grep("Il1b", annot$gene1, value = TRUE)
...
annot[grep("Il1b", annot$gene1),]
annot[grep("Il1b", annot$gene1), 1]

# Retrieve Park2 expression data from the islet tissue.
park2_islet <- islet.rz[, annot[grep("Park2", annot$gene1), 1]]

Il1b_adipose <- adipose.rz[, annot[grep("Il1b", annot$gene1), 1]]
...
f2g$pheno <- cbind(f2g$pheno[,c("MouseNum","Sex","pgm")],phenotypes.rz[,c("Fat.wt","BW.10wk","adipose.turnover",)],  park2_islet, iapp_islet, pink1_islet,  atg5_liver, atg7_liver,atg7_islet, atg5_islet)
